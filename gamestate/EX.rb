...
#    $window.caption = "Chingu Example #{@n} - #{@descr}"
    ...
    @title2 = Chingu::Text.create(:text=>"Controls:" , :x=>110, :y=>230, :size=>42)

    @title3 = Chingu::Text.create(:text=>"#{@cntrls}" , :x=>290, :y=>230, :size=>42)

    @title0 = Chingu::Text.create(:text=>"Press Enter to Continue" , :x=>110, :y=>350, :size=>46)
...
#
class Unsolved < Chingu::GameState
	def initialize(n, descr, cntrls, example)
    @n = n
	  @descr = descr
	  @cntrls = cntrls
    ...
    super(options)
#    $window.caption = "Chingu Example #{@n} - #{@descr}"
    @title1 = Chingu::Text.create(:text=>"Example #{@n} - #{@descr}\n    UNSOLVED" , :x=>110, :y=>130, :size=>52)
    @title2 = Chingu::Text.create(:text=>"This example is not yet loading properly" , :x=>110, :y=>230, :size=>36)
